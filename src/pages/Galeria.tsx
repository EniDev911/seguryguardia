...
import pic01 from '../assets/items/galeria/1.jpg'
import pic02 from '../assets/items/galeria/2.jpg'
import pic03 from '../assets/items/galeria/3.jpg'
import pic04 from '../assets/items/galeria/4.jpg'
import pic05 from '../assets/items/galeria/5.jpg'
import pic06 from '../assets/items/galeria/6.jpg'
import pic07 from '../assets/items/galeria/7.jpg'
import pic08 from '../assets/items/galeria/8.jpg'
import pic09 from '../assets/items/galeria/9.jpg'
...
const Galeria = () => {
  ...
  <Container className="my-5">
    ...
    photos.map(pic => {
      return (
        <Col key={pic} xs={11} sm={10} md={6} lg={4} xl={3} className="mx-auto text-center">
        <Card bg="dark" className="border border-3 border-dark" style={{
          background: `url(${pic})`,
          height: '290px',
        ...
        <Button variant="outline-warning" className="rounded-0" onClick={() => {showModal(pic)}}>Expandir</Button>
        </Card.Footer>
        </Col>
      )
    })}
